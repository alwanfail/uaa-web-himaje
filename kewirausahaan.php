...
<head>
  ...
  <title>Kewirausahaan HIMAJE</title>
...
<div class="container">
    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict kewirausahaan/REINALDI KOOR KWU(1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">KOOR</h4>
            <h5 class="profile-name">REINALDI</h5><br>
            <small>"Jadilah cahaya dalam kegelapan,Kesuksesan dimulai dari langkah pertama"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict kewirausahaan/AZIZAH DEVI STAFF KWU(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">AZIZAH DEVIF</h5><br>
            <small>"Yakin pada diri sendiri adalah kunci"</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-personal">
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict kewirausahaan/AZRA LULUK STAFF KWU(1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">AZRA LULUK</h5><br>
            <small>"Terus maju, jangan pernah menyerah"</small>
          </div>
        </div>
      </div>
      <div class="garis-tengah-10"></div>
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict kewirausahaan/KHAIRUN NISA STAFF KWU(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">KHAIRUN NISA</h5><br>
            <small>"Kehidupan adalah petualangan yang menunggu"</small>
          </div>
        </div>
      </div>
    </div>
