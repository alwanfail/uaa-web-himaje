...
<div class="container">
  <div class="subtitle">
    <p class="teks-yo">Sebagai penanggung jawab dalam menjalankan program kerja yang telah ditetapkan atas dan membuat kebijakan dalam HIMAJE</p>
  </div>
    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict bendahara/HALIMATUSA'DIAH BENDAHARA 1(1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">BENDAHARA 1</h4>
            <h5 class="profile-name">HALIMATUSA'DIAH</h5><br>
            <small>"Hidup hanya bisa dimengerti dengan melihat ke belakang, tetapi ia terus berlanjut ke depan"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict bendahara/HENY FITRIANTI BENDAHARA 2(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">BENDAHARA 2</h4>
            <h5 class="profile-name">HENY FITRIANI</h5><br>
            <small>"Jika kamu benar-benar menginginkan sesuatu, lambat laun kamu pasti akan segera menemukan caranya"</small>
          </div>
        </div>
      </div>
    </div>
