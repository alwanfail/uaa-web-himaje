...
<div class="container">
  <div class="subtitle">
    <p class="teks-yo">Mewadahi dan mengembangkan potensi masyarakat atau anggota manajmen di  bidang akademik dan melakukan kolaborasi dengan Lembaga di tingkat fakultas dalam  hal pengembangan SDM</p>
  </div>
    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict psdm/ABDAN KOOR PSDM.png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">KOOR</h4>
            <h5 class="profile-name">ABDAN</h5><br>
            <small>"Dalam setiap kegagalan, kekuatan mental kita yang tengah diuji. Sebaliknya, dalam kesuksesan, kerendahan hati kitalah yang tengah diuji"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict psdm/EKO SANTOSO STAFF PSDM.png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">EKO SANTOSO</h5><br>
            <small>"Kunci untuk mewujudkan impian bukanlah dengan fokus pada kesuksesan tapi pada arti. Bahkan langkah kecil dan kemenangan kecil sepanjang perjalananmu bisa memberikan arti yang lebih hebat"</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-personal">
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict psdm/HAMAM STAFF PSDM.png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">HAMAM</h5><br>
            <small>"Jika kamu tidak mengikuti apa yang ada di hatimu, kamu mungkin akan berakhir menghabiskan sisa waktumu dengan berharap pada yang sudah terlewat"</small>
          </div>
        </div>
      </div>
      <div class="garis-tengah-10"></div>
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict psdm/HILMI AULIA STAFF PSDM.png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">HILMI AULIA</h5><br>
            <small>"Tidak ada yang namanya kebetulan. Kesempatan datang karena diciptakan. Jadi, jangan terus-terusan berpangku tangan"</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-personal">
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict psdm/PUPUT PUTRI STAFF PSDM.png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">PUPUT PUTRI</h5><br>
            <small>"Tidak perlu malu untuk menangis, sebab air mata merupakan saksi dari keberanian manusia yang paling besar. Keberanian untuk menderita." <br>- Viktor E. Frankl</small>
          </div>
        </div>
      </div>
    </div>
