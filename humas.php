...
<div class="container">
  <div class="subtitle">
    <p class="teks-yo">Menjadi wadah aktivitas mahasiswa manajemen dalam meyalurkan kegiatan  sosial kemasyarakatan dan meningkatkan kepedulian serta mengajak mahasiswa  manajemen untuk berpartisipasi  dalam kegiatan sosial kemasyarakatan</p>
  </div>
    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict humas/ANANG KOOR HUMAS.png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">KOOR</h4>
            <h5 class="profile-name">ANANG</h5><br>
            <small>“Sukses terdiri dari rentetan kegagalan, tanpa kehilangan antusiasme"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict humas/A'RAF STAFF HUMAS.png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">A'RAF</h5><br>
            <small>"Setiap kesulitan selalu ada kemudahan. Setiap masalah pasti ada solusi"</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-personal">
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict humas/SURYA STAFF HUMAS.png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">SURYA</h5><br>
            <small>"Kegagalan terjadi karena terlalu banyak berencana tapi sedikit berpikir, Kebanyakan kegagalan berasal dari takut gagal"</small>
          </div>
        </div>
      </div>
      <div class="garis-tengah-10"></div>
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict humas/TONI STAFF HUMAS.png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">TONI</h5><br>
            <small>"Jika orang lain bisa, maka aku juga bisa." "Berani bermimpi, gigih meraihnya"</small>
          </div>
        </div>
      </div>
    </div>
