    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict sekretaris/ARI FIRMANSYAH SEKRE 1 (1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">SEKRETARIS 1</h4>
            <h5 class="profile-name">ARI FIRMANSYAH</h5><br>
            <small>"Hidup kita mulai berakhir saat kita berdiam diri tentang apapun masalah yang ada di sekitar"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict sekretaris/SITI AFDOLIAH SEKRE 2(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">SEKRETARIS 2</h4>
            <h5 class="profile-name">HENY FITRIANI</h5><br>
            <small>"Sampai singa tahu bagaimana caranya menulis, tiap cerita akan selalu menyanjung pemburu"</small>
          </div>
        </div>
      </div>
    </div>
