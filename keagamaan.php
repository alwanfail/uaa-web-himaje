...
<div class="container">
  <div class="subtitle">
    <p class="teks-yo">Berpartisipasi dalam pelaksanaan hari besar islam di dalam internal ataupun  eksternal dan menjamin nilai - nilai keislaman Ahlun sunnah Wal Jama'ah yang telah  diterapkan di dalam kampus</p>
  </div>
    ...
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict keagamaan/RIZAL AKHID KOOR KEAGAMAAN(1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">KOOR</h4>
            <h5 class="profile-name">RIZAL AKHID</h5><br>
            <small>"Bergantung pada diri sendiri, bukan pada keberuntungan"</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict keagamaan/ANNISA FADHILA STAFF KEAGAMAAN(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">ANNISA FADHILA</h5><br>
            <small>"Setiap hari adalah kesempatan baru"</small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-personal">
    <div class="personal-card">
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict keagamaan/AUSTY AZUM STAFF KEAGAMAAN(1).png" alt="Halimatusadiah" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">AUSTY AZUM</h5><br>
            <small>"Bersyukur atas yang ada, raih yang belum"</small>
          </div>
        </div>
      </div>
      <div class="garis-tengah-10"></div>
      <div class="col-md-5">
        <div class="profile-container">
          <img src="pict keagamaan/VANIA ANDANI STAFF KEAGAMAAN(1).png" alt="Heny Fitriani" class="profile-img">
          <div class="profile-info">
            <h4 class="profile-role">ANGGOTA</h4>
            <h5 class="profile-name">VANIA ANDANI</h5><br>
            <small>"Keberhasilan adalah perjalanan, bukan destinasi"</small>
          </div>
        </div>
      </div>
    </div>
